...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['update_profil'])) {
    ...
    $check_username = "SELECT id FROM admin WHERE username = '$username' AND id != $user_id";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['update_password'])) {
    ...
    $update_password_query = "UPDATE admin SET password = '$password_hash' WHERE id = $user_id";
...
<head>
    ...
    <title>Profil Admin - Puskesmas Nalumsari</title>
                ...
                <div class="profile-info">
                    ...
                    <div class="profile-meta">
                        ...
                        <div class="meta-item">
                            ...
                            <span>Bergabung: <?php echo date('d/m/Y', strtotime($admin['created_at'])); ?></span>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" id="nama_lengkap" name="nama_lengkap" 
                                   class="form-control" value="<?php echo htmlspecialchars($admin['nama_lengkap']); ?>" 
                                   required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="username" name="username" 
                                   class="form-control" value="<?php echo htmlspecialchars($admin['username']); ?>" 
                                   required>
                        </div>
                    </div>
